...
class User extends Component {
  ...
  getFormattedMoment = (dateString, withTime) => {
    if (dateString && withTime) {
      return this.getMomentFromDateString(dateString).format(
        'D.M.YYYY h.mm.ss'
      );
    } else if (dateString) {
  ...
  saveUser = () => {
    ...
    const saveUser = {
      ...
      birthdate: this.state.birthdate
        ? this.state.birthdate.format('YYYY-MM-DD')
        : null,
  ...
  render() {
    ...
    return (
      <div className={classes.userComponent}>
        ...
        <label>ID</label>
        <p>
          state: {this.state.id}, props: {this.props.user.id}.
        </p>
        <form className={classes.Form}>
          <FormGroup>
            <ControlLabel className={classes.Label} htmlFor="firstname">
              First Name
            </ControlLabel>
            <FormControl
          ...
          <FormGroup>
            <ControlLabel className={classes.Label} htmlFor="lastname">
              Last Name
            </ControlLabel>
            <FormControl
              className={classes.Input}
          ...
          <FormGroup>
            <ControlLabel className={classes.Label} htmlFor="email">
              Email
            </ControlLabel>
            <FormControl
              className={classes.Input}
          ...
          <FormGroup className={classes.formGroup}>
            <ControlLabel className={classes.Label} htmlFor="dateofbirth">
              Date of Birth
            </ControlLabel>
          ...
          <FormGroup>
            <ControlLabel className={classes.Label} htmlFor="phone">
              Phone
            </ControlLabel>
            <FormControl
              className={classes.Input}
          ...
          <FormGroup>
            <ControlLabel className={classes.Label} htmlFor="streetAddress">
              Street Address
            </ControlLabel>
            <FormControl
              className={classes.Input}
          ...
          <FormGroup>
            <ControlLabel className={classes.Label} htmlFor="postalCode">
              Postal Code
            </ControlLabel>
            <FormControl
              className={classes.Input}
          ...
          <FormGroup>
            <ControlLabel className={classes.Label} htmlFor="rewards">
              Rewards
            </ControlLabel>
            <FormControl
              className={classes.Input}

        ...
        return (
            <div className={classes.container}>
                ...
                <Table className={classes.table}>
                    ...
                    <tbody>
                    {this.props.accountsManager.accounts && this.props.accountsManager.accounts.map(account => {
                        return (
                            <tr key={account.id}>
                                <td>{account.id}</td>
                                ...
                                <td>
                                    <ButtonGroup>
                                        <Button onClick={() => this.editAccount(account)} bsStyle="success">Edit</Button>
                                        <Button onClick={() => this.deleteAccount(account)} bsStyle="danger">Delete</Button>
                                    </ButtonGroup>
                                </td>
                            </tr>
                        )
                    ...
                    <tr>
                        <td></td>
                        <td><Button onClick={this.createAccount} bsStyle="primary">Add New Account</Button></td>
                        <td></td>
                    </tr>
                    </tbody>
                </Table>

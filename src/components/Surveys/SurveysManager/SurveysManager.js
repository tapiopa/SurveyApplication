    ...
    return (
      <div className={classes.surveysManager}>
        ...
        <Table className={classes.table}>
          ...
          <tbody>
            {this.props.surveysManager.surveys &&
              this.props.surveysManager.surveys.map(survey => {
                return (
                  <tr key={survey.id}>
                    <td>{survey.id}</td>
                    <td>{survey.title}</td>
            ...
            <tr>
              <td />
              <td>
                <Button onClick={this.addNewSurvey} bsStyle="primary">
                  Add New Survey
                </Button>
              </td>
...
export default Protected(
  connect(
    mapStateToProps,
    mapDispatchToProps
  )(withErrorHandler(SurveysManager, axios))
);
